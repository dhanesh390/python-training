...
def get_valid_amount():
    ...
    def create_account():
        ...
        new_account.set_aadhar_number(
            util.validate_input(input('Enter your aadhar number in the (**** **** ****) format:'),
                                myconstants.AADHAR_PATTERN,
                                'Enter a valid 12 digit aadhar number'))
        date_of_birth = util.validate_input(input("Enter your birth date (dd/mm/yyyy):"),
                                            myconstants.DATE_OF_BIRTH_PATTERN,
...
class AccountController:
    ...
    def _init_():
        ...
        while get_input:
            ...
            match user_choice:
                case 1:
                    print(AccountService.create_account())
